...
public class Lion extends Animal{
	...
	public Homme verifieRouge ( int posx, int posy, Animal an ,PlateauDeJeu P1) {
			...
			if( pos[1] == posy ) {
					if( pos[0] == posx ) { System.out.println("Vous changer rien... "); }
					else if( posx > pos[0] ) {
							for( int i = pos[0]+1 ; i <= posx ; i++ ) {
									...
									if( animalInMyWay.lastIndexOf("r") == animalInMyWay.length()-1 ) {
										...
										System.out.println(" ########## Deplacer '" + P1.getAnimalByPosition(i, posy) + "' en avant dabord !!  ########## ");
										return null;
									}
							}
					} else {
							...
							if ( pos[1] < posy ) {
								...
								for( int i = pos[1]+1 ; i <= posy ; i++ ) {
									...
									if( animalInMyWay.lastIndexOf("r") == animalInMyWay.length()-1 ) {
										...
										System.out.println(" ########## Deplacer " + P1.getAnimalByPosition(posx, i) + " en avant dabord !!  ########## ");
										return null;
									}
	...
	public Machine verifieVert ( int posx, int posy, Animal an ,PlateauDeJeu P1) {
		...
		if( pos[1] == posy ) {
				if( pos[0] == posx ) {
					System.out.println("Vous changez rien... ");
				} else if( posx > pos[0] ) {
						for( int i = pos[0]+1 ; i <= posx ; i++ ) {
								String animalInMyWay = P1.getAnimalByPosition(i, posy);
